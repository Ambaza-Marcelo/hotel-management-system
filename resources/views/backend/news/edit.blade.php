        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <form novalidate id="entryForm" action="{{route('admin-news-update',$news->id) }}" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            @csrf
                            @method('put')
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input autofocus type="text" class="form-control" name="title" value="{{$news->title}}" required minlength="2" maxlength="255">

@extends('layouts.app')
@section('title','create report kitchen')
@section('content')
<div class="container">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                Creer un rapport de la cuisine 
                <div class="box box-info">
                    <form novalidate id="entryForm" action="{{route('report-kitchen-store')}}" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input autofocus type="date" class="form-control" name="date" placeholder="date" required minlength="2" maxlength="255">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <select id="type" class="form-control" name="type">
                                            <option selected="selected">choisir type</option>

        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="box box-info">
                    <form novalidate id="entryForm" action="{{route('admin-room-store')}}" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input type="number" name="num_room" class="form-control" placeholder="Room No">

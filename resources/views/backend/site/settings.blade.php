                    ...
                    <form  id="settingsForm" action="{{URL::Route('site.settings')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <input type="text" name="name" class="form-control" placeholder="App name" value="@if($info){{ $info->name }}@endif" maxlength="255" required />
                                <span class="fa fa-info form-control-feedback"></span>
                                <span class="text-danger">{{ $errors->first('name') }}</span>
                            </div>
                            <div class="form-group has-feedback">
                                <label for="short_name">App Short Name<span class="text-danger">*</span></label>
                                <input type="text" name="short_name" class="form-control" placeholder="App short name" value="@if($info){{ $info->short_name }}@endif" maxlength="255" required />
                                <span class="fa fa-info form-control-feedback"></span>

@extends('layouts.app')
@section('title','create Command Food')
@section('content')
        <div class="container">
              <h2>Create Command Food</h2>
              <form class="form-horizontal" method="POST" action="{{ route('command-food.store') }}" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                    <label for="title" class="col-md-4 control-label">@lang('Create Command Food')</label>

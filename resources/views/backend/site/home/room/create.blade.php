        ...
        <div class="container">
              ...
              <form class="form-horizontal" method="POST" action="{{ route('room.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                    <label for="title" class="col-md-4 control-label">@lang('Create Room')</label>
               ...
               <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                ...
                <div class="form-group{{ $errors->has('num') ? ' has-error' : '' }}">
                    <label for="num" class="col-md-4 control-label">@lang('No')</label>

                    <div class="col-md-6">
                        <input type="number" name="num" class="form-control" placeholder="No Room">

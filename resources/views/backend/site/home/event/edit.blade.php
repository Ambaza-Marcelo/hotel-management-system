        ...
        <div class="row">
            <div class="col-md-12">
                <div class="box box-info">
                    <form novalidate id="entryForm" action="{{route('events.update',$event->id)}}" method="post" enctype="multipart/form-data">
                        <div class="box-body">
                            @csrf
                            @method('put')
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input  type="date" class="form-control" name="date" required value="{{$event->date}}" min="1" maxlength="10">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group has-feedback">
                                        ...
                                        <input  type="time" class="form-control" name="time" required value="{{$event->time}}" min="1" maxlength="10">
                                        <span class="fa fa-phone form-control-feedback"></span>
